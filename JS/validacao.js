...
const mensegensErro = {
    ...
    cep: {
        ...
        patternMismatch: 'CEP informado não é válido!',
        customError: 'CEP não encontrado, verifique os dados'
    },
    logradouro: {
...
function recuperarCEP(input){
    ...
    if(!input.validity.patternMismatch && !input.validity.valueMissing){
        fetch(url, options).then(
            ...
            data => {
                if(data.erro){
                    input.setCustomValidity('CEP não encontrado, verifique os dados');
                    return;
                }
